    ...
    <div className='h-[10%] bg-black flex justify-between items-center text-white px-4'>
        ...
        <div className="flex flex-col items-center gap-1  m-auto">
            <div className="flex gap-4 ">
                ...
                <img className='w-4 cursor-pointer' src={assets.prev_icon} alt="" srcset="" />
                <img className='w-4 cursor-pointer' src={assets.play_icon} alt="" srcset="" />
                <img className='w-4 cursor-pointer' src={assets.next_icon} alt="" srcset="" />
